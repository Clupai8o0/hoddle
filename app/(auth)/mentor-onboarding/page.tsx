  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <header className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-[20px] border-b border-outline-variant px-4 sm:px-8 py-3 sm:py-4 flex justify-between items-center gap-3">
        ...
        <span className="font-body text-[10px] sm:text-xs text-on-surface-variant uppercase tracking-[0.15em] text-right">
          <span className="hidden sm:inline">Mentor profile — </span>Step {step} of {TOTAL_STEPS}
        </span>
      </header>
