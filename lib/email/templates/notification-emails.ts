...
function ctaButton(href: string, label: string): string {
  return `<a href="${href}" style="display:inline-block;margin:24px 0 0;padding:14px 28px;background:#001842;color:#fef8f1;font-family:'Plus Jakarta Sans',sans-serif;font-size:15px;font-weight:700;border-radius:10px;text-decoration:none;">${label}</a>`;
}
    ...
    case "forum_reply_to_your_thread": {
      ...
      return {
        ...
        html: emailShell(`
          ...
          <h1 style="margin:0 0 16px;font-family:'Plus Jakarta Sans',sans-serif;font-size:24px;font-weight:800;color:#2a2620;line-height:1.2;">Someone replied to your thread</h1>
          <p style="margin:0 0 0;font-family:'Be Vietnam Pro',sans-serif;font-size:16px;color:#6b7280;line-height:1.6;">Hi ${firstName}, <strong style="color:#2a2620;">${replierName}</strong> replied to your thread <strong style="color:#2a2620;">"${threadTitle}"</strong> in the Hoddle community forum.</p>
    ...
    case "success_story_approved": {
      ...
      return {
        ...
        html: emailShell(`
          ...
          <h1 style="margin:0 0 16px;font-family:'Plus Jakarta Sans',sans-serif;font-size:24px;font-weight:800;color:#2a2620;line-height:1.2;">Your story is live!</h1>
          <p style="margin:0;font-family:'Be Vietnam Pro',sans-serif;font-size:16px;color:#6b7280;line-height:1.6;">Hi ${firstName}, your story <strong style="color:#2a2620;">"${storyTitle}"</strong> has been approved and is now published on Hoddle for the whole community to read.</p>
    ...
    case "mentor_replied_to_your_question": {
      ...
      return {
        ...
        html: emailShell(`
          ...
          <h1 style="margin:0 0 16px;font-family:'Plus Jakarta Sans',sans-serif;font-size:24px;font-weight:800;color:#2a2620;line-height:1.2;">Your question was answered</h1>
          <p style="margin:0;font-family:'Be Vietnam Pro',sans-serif;font-size:16px;color:#6b7280;line-height:1.6;">Hi ${firstName}, <strong style="color:#2a2620;">${mentorName}</strong> answered your question for the session <strong style="color:#2a2620;">"${sessionTitle}"</strong>.</p>
    ...
    case "new_content_from_mentor_you_follow": {
      ...
      return {
        ...
        html: emailShell(`
          ...
          <h1 style="margin:0 0 16px;font-family:'Plus Jakarta Sans',sans-serif;font-size:24px;font-weight:800;color:#2a2620;line-height:1.2;">New article from someone you follow</h1>
          <p style="margin:0;font-family:'Be Vietnam Pro',sans-serif;font-size:16px;color:#6b7280;line-height:1.6;">Hi ${firstName}, <strong style="color:#2a2620;">${mentorName}</strong> just published <strong style="color:#2a2620;">"${contentTitle}"</strong> in the Hoddle content library.</p>
    ...
    case "session_reminder_24h": {
      ...
      return {
        ...
        html: emailShell(`
          ...
          <h1 style="margin:0 0 16px;font-family:'Plus Jakarta Sans',sans-serif;font-size:24px;font-weight:800;color:#2a2620;line-height:1.2;">Your session is tomorrow</h1>
          <p style="margin:0;font-family:'Be Vietnam Pro',sans-serif;font-size:16px;color:#6b7280;line-height:1.6;">Hi ${firstName}, just a reminder that <strong style="color:#2a2620;">"${sessionTitle}"</strong> is coming up tomorrow.</p>
          ${ctaButton(sessionUrl, "View session")}
        `),
      };
    }
    ...
    case "session_starting_soon": {
      ...
      return {
        ...
        html: emailShell(`
          ...
          <h1 style="margin:0 0 16px;font-family:'Plus Jakarta Sans',sans-serif;font-size:24px;font-weight:800;color:#2a2620;line-height:1.2;">Your session starts soon</h1>
          <p style="margin:0;font-family:'Be Vietnam Pro',sans-serif;font-size:16px;color:#6b7280;line-height:1.6;">Hi ${firstName}, <strong style="color:#2a2620;">"${sessionTitle}"</strong> starts in about 15 minutes.</p>
          ${joinSection}
        `),
      };
    }
